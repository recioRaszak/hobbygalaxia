...
= 1.2.16 - 2024-06-26 =
* Updated banner in repository view.
* Added support for WooCommerce 9.0

= 1.2.15 - 2024-06-04 =
* Improved accessibility features for "Add to wishlist" button.
* Marked wishlist pages as non-indexable to avoid search engines crawling them.

= 1.2.14 - 2024-04-02 =
* Removed upgrade to PRO notice.
* Added support for WordPress 6.5.
* Raised minimal WordPress version to 6.3.
