...
namespace FlexibleWishlistVendor\WPDesk\Notice;

use FlexibleWishlistVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
 ...
 */
class AjaxHandler implements \FlexibleWishlistVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            $optionName = \FlexibleWishlistVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName;
            ...
            \update_option($optionName, \FlexibleWishlistVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
