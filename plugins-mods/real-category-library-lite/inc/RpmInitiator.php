...
class RpmInitiator extends AbstractInitiator
{
    ...
    {
        return \__('https://devowl.io/knowledge-base/codecanyon-where-can-i-find-my-license-key/', RCL_TD);
    }
    /**
     * Documented in AbstractInitiator.
     *
    ...
    {
        return \DevOwl\RealCategoryLibrary\Core::getInstance()->getDefaultTaxTree()->isAvailable(\true) || \DevOwl\RealCategoryLibrary\Core::getInstance()->getConfigPage()->isVisible();
    }
    /**
     * Documented in AbstractInitiator.
     *
